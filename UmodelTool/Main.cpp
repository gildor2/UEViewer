...
static void RegisterUnrealClasses4()
{
	...
	BEGIN_CLASS_TABLE
		...
		REGISTER_EXPRESSION_CLASSES
		/*
		* Adding umap and landscape support
		*/
		//DHK_BEGIN
		REGISTER_UNMAP_CLASSES4
		REGISTER_LANDSCAPE_CLASSES
		//DHK_END
		END_CLASS_TABLE
		/*
		* Adding Miscellaneous enums for UE4
		*/
		//DHK_BEGIN
		REGISTER_MISC_ENUMS_U4
		//DHK_END
...
int main(int argc, const char** argv)
{
	...
	for (int i = 0; i < packagesToLoad.Num(); i++)
	{
		...
		FString sPattern = "/Game/Levels/Zeffo/Venator/";
		const char* c = "*.umap";
