...
static void APIENTRY logUniform1i(GLint index, GLint value)
{
	printf("%s (%d, %d)\n", "glUniform1i", index, value);
	lib.Uniform1i(index, value);
}
...
static GLboolean APIENTRY logIsRenderbufferEXT(GLuint renderbuffer)
{
	printf("%s (%d)\n", "glIsRenderbufferEXT", renderbuffer);
	return lib.IsRenderbufferEXT(renderbuffer);
}
...
static void APIENTRY logGetRenderbufferParameterivEXT(GLenum target, GLenum pname, GLint *params)
{
	printf("%s (GL_%s, GL_%s, $%X)\n", "glGetRenderbufferParameterivEXT", EnumName(target), EnumName(pname), (unsigned)params);
	lib.GetRenderbufferParameterivEXT(target, pname, params);
}

static GLboolean APIENTRY logIsFramebufferEXT(GLuint framebuffer)
{
	printf("%s (%d)\n", "glIsFramebufferEXT", framebuffer);
	return lib.IsFramebufferEXT(framebuffer);
}
...
static void APIENTRY logFramebufferTexture1DEXT(GLenum target, GLenum attachment, GLenum textarget, GLuint texture, GLint level)
{
	printf("%s (GL_%s, GL_%s, GL_%s, %d, %d)\n", "glFramebufferTexture1DEXT", EnumName(target), EnumName(attachment), EnumName(textarget), texture, level);
	lib.FramebufferTexture1DEXT(target, attachment, textarget, texture, level);
}
...
static void APIENTRY logFramebufferTexture3DEXT(GLenum target, GLenum attachment, GLenum textarget, GLuint texture, GLint level, GLint zoffset)
{
	printf("%s (GL_%s, GL_%s, GL_%s, %d, %d, %d)\n", "glFramebufferTexture3DEXT", EnumName(target), EnumName(attachment), EnumName(textarget), texture, level, zoffset);
	lib.FramebufferTexture3DEXT(target, attachment, textarget, texture, level, zoffset);
}
...
static void APIENTRY logGetFramebufferAttachmentParameterivEXT(GLenum target, GLenum attachment, GLenum pname, GLint *params)
{
	printf("%s (GL_%s, GL_%s, GL_%s, $%X)\n", "glGetFramebufferAttachmentParameterivEXT", EnumName(target), EnumName(attachment), EnumName(pname), (unsigned)params);
	lib.GetFramebufferAttachmentParameterivEXT(target, attachment, pname, params);
}
...
static extInfo_t extInfo[NUM_EXTENSIONS] = {
	...
	{"2.0\0", NULL, NULL, NUM_GLFUNCS+1, 21, 0, 0},
	{"GL_EXT_framebuffer_object\0", NULL, NULL, NUM_GLFUNCS+22, 17, 0, 0}
#if _WIN32
